...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        common_1.Module({
            ...
            controllers: [app_controller_1.AppController, user_controller_1.UserController, attendance_controller_1.AttendanceController, bulletin_controller_1.BulletinController, clearance_controller_1.ClearanceController, records_controller_1.RecordsController, archived_controller_1.ArchivedController, media_controller_1.MediaController, students_controller_1.StudentsController],
            providers: [app_service_1.AppService, user_service_1.UserService, attendance_service_1.AttendanceService, bulletin_service_1.BulletinService, clearance_service_1.ClearanceService, records_service_1.RecordsService, archived_service_1.ArchivedService, media_service_1.MediaService, students_service_1.StudentsService]
        })
    ], AppModule);
    return AppModule;
}());
